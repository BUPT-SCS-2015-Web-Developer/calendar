                ...
                <div class="card-panel z-depth-3">
                    <div class="row">
                        <div class="input-field">
                            <input id="matters_name" type="text" class="validate">
                            <label for="matters_name">活动名称</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field">
                            <input id="matters_organization" type="text" class="validate">
                    ...
                    <div class="row">
                        ...
                        <p>
                            <input class="with-gap" name="group1"  type="radio" id="orange" />
                   ...
                   <div class="input-field">
                        <textarea id="notice" class="materialize-textarea" length=255></textarea>
